...
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22), __webpack_require__(50)(module)))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37);
...
var tiny_warning_esm = __webpack_require__(6);
...
var GridList_GridList = /*#__PURE__*/react["forwardRef"](function GridList(props, ref) {
 ...
 false ? undefined : void 0;
/* harmony default export */ var esm_GridList_GridList = (styles_withStyles(GridList_styles, {
  name: 'MuiGridList'
})(GridList_GridList));
...
var GridListTile_GridListTile = /*#__PURE__*/react["forwardRef"](function GridListTile(props, ref) {
 ...
 false ? undefined : void 0;
/* harmony default export */ var esm_GridListTile_GridListTile = (styles_withStyles(GridListTile_styles, {
  name: 'MuiGridListTile'
})(GridListTile_GridListTile));
// CONCATENATED MODULE: ./src/redux/types/types.js
var INITIAL_ADS = "INITIAL_ADS";
var ADD_AD = "ADD_AD";
// CONCATENATED MODULE: ./src/redux/actions/action.js

var action_initialAds = function initialAds(ads) {
  return {
    type: INITIAL_ADS,
    payload: {
      initialAds: ads
...
var action_addAdAction = function addAdAction(newAd) {
  return {
    type: ADD_AD,
    payload: {
      newAd: newAd
...
// CONCATENATED MODULE: ./src/components/AddAd.js
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { AddAd_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function AddAd_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function AddAd_slicedToArray(arr, i) { return _arrayWithHoles(arr) || AddAd_iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
function AddAd_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function AddAd(_ref) {
  ...
  var _useState = Object(react["useState"])((_useState3 = {}, AddAd_defineProperty(_useState3, IDS.TITLE, ""), AddAd_defineProperty(_useState3, IDS.BODY, ""), _useState3)),
      _useState2 = AddAd_slicedToArray(_useState, 2),
      state = _useState2[0],
  ...
  var onChange = function onChange(event) {
    ...
    setState(function (currentState) {
      return _objectSpread(_objectSpread({}, currentState), {}, AddAd_defineProperty({}, id, value));
    });
  };
  ...
  function submitHandler(event) {
    ...
    event.preventDefault();
    onCreate(_objectSpread(_objectSpread({}, state), {}, {
      id: esm_browser_v4()
    }));
    setState((_setState = {}, AddAd_defineProperty(_setState, IDS.TITLE, ""), AddAd_defineProperty(_setState, IDS.BODY, ""), _setState));
  }
...
/* harmony default export */ var components_AddAd = (AddAd);
// CONCATENATED MODULE: ./src/pages/callboard/Callboard.js
function Callboard_toConsumableArray(arr) { return Callboard_arrayWithoutHoles(arr) || _iterableToArray(arr) || Callboard_unsupportedIterableToArray(arr) || Callboard_nonIterableSpread(); }

function Callboard_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function Callboard_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Callboard_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Callboard_arrayLikeToArray(o, minLen); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function Callboard_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return Callboard_arrayLikeToArray(arr); }

function Callboard_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var Callboard_useStyles = styles_makeStyles(function (theme) {
  return {
    root: {
      display: "flex",
      flexWrap: "wrap",
...
function Callboard() {
  var classes = Callboard_useStyles();
  var dispatch = useDispatch();

  var _useSelector = useSelector_useSelector(function (state) {
    return state.reducer;
  }),
      ads = _useSelector.ads;

  Object(react["useEffect"])(function () {
    axios_default.a.get("https://simple-blog-api.crew.red/posts?_limit=7").then(function (data) {
      if (!ads.length) {
        return;
      }

      dispatch(action_initialAds(data.data));
    })["catch"](function (err) {
      console.log("Error!", err);
    });
  }, []);
  Object(react["useEffect"])(function () {
    var saved = JSON.parse(localStorage.getItem("ads") || "[]");
    dispatch(action_initialAds(saved));
  }, []);

  var addAd = function addAd(newAd) {
    dispatch(action_addAdAction(newAd));
    localStorage.setItem("ads", JSON.stringify([].concat(Callboard_toConsumableArray(ads), [newAd])));
  };

  return /*#__PURE__*/react_default.a.createElement("div", {
    className: classes.container
  }, /*#__PURE__*/react_default.a.createElement(components_AddAd, {
    onCreate: addAd
  }), /*#__PURE__*/react_default.a.createElement("div", {
    className: classes.root
  }, /*#__PURE__*/react_default.a.createElement(esm_GridList_GridList, {
    cellHeight: 100,
    spacing: 10,
    ...
    }, ads.title), /*#__PURE__*/react_default.a.createElement("p", {
      className: classes.body
    }, ads.body)));
  }))));
}

/* harmony default export */ var callboard_Callboard = (Callboard);
// CONCATENATED MODULE: ./src/pages/homepage/HomePage.js



var HomePage_useStyles = styles_makeStyles(function (theme) {
  return {
    homePageContainer: {
      display: "flex",
      height: "100%",
...
function HomePage() {
  ...
  return /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: classes.title
  }, "\u0412\u0456\u0442\u0430\u0454\u043C\u043E \u043D\u0430 \u0434\u043E\u0448\u0446\u0456 \u043E\u0433\u043E\u043B\u043E\u0448\u0435\u043D\u044C!"), /*#__PURE__*/react_default.a.createElement(Link, {
...
var Navbar_useStyles = styles_makeStyles(function (theme) {
  return {
    nav: {
      display: "flex",
      justifyContent: "space-around",
...
function Navbar() {
  ...
  return /*#__PURE__*/react_default.a.createElement("nav", {
    ...
    href: "/"
  }, "Bulletin board"), /*#__PURE__*/react_default.a.createElement("ul", null, /*#__PURE__*/react_default.a.createElement("li", null, /*#__PURE__*/react_default.a.createElement(NavLink, {
    to: "/"
  }, "\u041D\u0430 \u0413\u043E\u043B\u043E\u0432\u043D\u0443"))));
}
...
// CONCATENATED MODULE: ./src/redux/reducers/reducer.js
...
var reducer_reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case ADD_AD:
      return reducer_objectSpread(reducer_objectSpread({}, state), {}, {
        ads: [].concat(reducer_toConsumableArray(state.ads), [action.payload.newAd])
      });
...
/* harmony default export */ var reducers_reducer = (reducer_reducer);
...
var store_store = Object(redux["createStore"])(Object(redux["combineReducers"])({
  reducer: reducers_reducer
}), Object(redux_devtools_extension["composeWithDevTools"])(Object(redux["applyMiddleware"])(es)));
/* harmony default export */ var redux_store_store = (store_store);
// EXTERNAL MODULE: ./src/pages/root/App.css
var App = __webpack_require__(69);

// CONCATENATED MODULE: ./src/pages/root/App.js
...
function App_App() {
  return /*#__PURE__*/react_default.a.createElement(components_Provider, {
    store: redux_store_store
  }, /*#__PURE__*/react_default.a.createElement(react_router_dom_BrowserRouter, null, /*#__PURE__*/react_default.a.createElement(components_Navbar, null), /*#__PURE__*/react_default.a.createElement(react_router_Switch, null, /*#__PURE__*/react_default.a.createElement(react_router_Route, {
    component: homepage_HomePage,
    path: "/",
    exact: true
  }), /*#__PURE__*/react_default.a.createElement(react_router_Route, {
    component: callboard_Callboard,
    path: "/callboard"
  }))));
}

/* harmony default export */ var root_App = (App_App);
// CONCATENATED MODULE: ./index.js



react_dom_default.a.render( /*#__PURE__*/react_default.a.createElement(react_default.a.StrictMode, null, /*#__PURE__*/react_default.a.createElement(root_App, null)), document.getElementById('root'));
